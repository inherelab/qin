...
use Toolkit\Traits\LogProfileTrait;
use Toolkit\Traits\PathResolverTrait;
...
class FileLogger implements LoggerInterface
{
     ...
     * @var string
     */
    protected $logFile = '/tmp/default.log';
...
//            ]) . "\n";
    ...
    public function log($level, $message, array $context = [], array $extra = [])
    {
        ...
        if ($this->logConsole && (PhpEnv::isBuiltInServer() || PhpEnv::isCli())) {
     ...
     * @return string
     */
    public function getBasePath($resolve = true): string
    {
